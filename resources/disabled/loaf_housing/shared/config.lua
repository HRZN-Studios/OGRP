...
Config = {
    ...
    AutoDelete = 30, -- if a property has not been entered for this many days, it will be deleted
    ...
    Key = {
        DistanceCheck = false, -- check if the player is nearby the door when using a key (false = can lock/unlock from anywhere, true = must be at the door)
    ...
    Garage = true, -- enable garages? Requires a supported garage script, such as cd_garage or loaf_garage
    ...
    Realtor = { -- REQUIRES https://store.loaf-scripts.com/package/4457135
        ...
        requireRealtor = false, -- require to purchase from a realtor, or allow purchasing from a circle?
    },

    ShellPacks = { -- set all packs you have bought to true here
        --[[
            K4MB1 Shells
            I highly recommend subscribing to his all shells sub pack here: https://www.k4mb1maps.com/package/5107241
            or purchasing all shells here: https://www.k4mb1maps.com/package/4741607
        --]]
        ...
        ["Vinewood Housing"] = false, -- purchase here: https://www.k4mb1maps.com/package/5251329
        ...
        ["AllShellsSubPack2"] = false,

        -- Max Creations shells
        ["Max Luxury Furnished V1"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/4935687
        ["Max Luxury Furnished V2"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/5185524
        ["Max Luxury Apartment"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/4908472
        ["Max Luxury Mansion"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/4908442
        ["Max Medium Apartment"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/4908466
        ["Max Small Apartment"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/4908464
        ["Max Furnished Rowhouse"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/5099333
        ["Max Furnished GTA IV"] = false, -- purchase here: https://maxcreationsstore.tebex.io/package/5055570
    },
