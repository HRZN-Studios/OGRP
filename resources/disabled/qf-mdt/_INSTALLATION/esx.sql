...
CREATE TABLE IF NOT EXISTS `qf_mdt_evidences` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` longtext NOT NULL,
...
CREATE TABLE IF NOT EXISTS `qf_mdt_housenotes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qf_mdt_profiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `identifier` varchar(46) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `qf_mdt_warrants` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` longtext NOT NULL,
  `subtitle` longtext NOT NULL,
  `creator` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `qf_mdt_time` (
  `identifier` varchar(46) DEFAULT NULL,
